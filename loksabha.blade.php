...
<body>
    <center><h1>LOKSABHA ELECTIONS</h1></center>
    ...
    <div class="inline">
        <form id="votingForm" action="">
            ...
            <p>
                ...
                <input type="text" id="state" value="GUJARAT" readonly> &nbsp;&nbsp;&nbsp;

                <label for="date">Date of Election</label>
                <input type="text" id="date" value="28 December 2023" readonly> &nbsp;&nbsp;&nbsp;

                <label for="constituency">Constituency</label>
                <input type="text" id="constituency" value="Ellis Bridge" readonly>
            </p>
            ...
            <center>
                ...
                <button type="button" onclick="window.location.href='votingwebsite';">Go To Voting Website</button>
            </center>
        </form>
    </div>
</body>
